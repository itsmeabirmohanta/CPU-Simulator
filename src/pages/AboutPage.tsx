...
import {
  ...
  Keyboard, Share2, BarChart3, Heart, Github, Linkedin, User } from
"lucide-react";
      ...
      <div className="container mx-auto px-4 py-16 max-w-6xl space-y-24">
        ...
        <motion.section
          ...
          <div className="relative px-8 py-14 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-6 max-w-lg mx-auto">Whether you're a student, educator, or curious mind, CPU Simulator is free and ready to explore.
