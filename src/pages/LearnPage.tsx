...
import ProgressTracker, {
  getOverallProgress,
  resetProgress } from
"@/components/learn/LessonProgress";
import {
  BookOpen, Cpu, Rocket, HelpCircle, ArrowRight, GraduationCap,
  Clock, Video, Layers, CheckCircle2 } from
"lucide-react";
        ...
        <div className="relative container mx-auto px-4 pt-14 pb-16 max-w-6xl">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, ease: EASE }}>
            <div className="text-center max-w-2xl mx-auto mb-8">
              ...
              <p className="text-base text-muted-foreground leading-relaxed">A comprehensive, university-level course, from binary basics to modern processor design. Learn by reading, watching, and building.
